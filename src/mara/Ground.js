...
function PrimarySearchAppBar(props) {
  ...
  useEffect( () => {
    if (daftarBencana === null){
      axios.get(`http://localhost:8000/api/ground`)
      .then(res => {
        setdaftarBencana(res.data.map(el=>{ return {id: el.id, nama_lokasi: el.nama_lokasi, deskripsi: el.deskripsi, horizontal: el.horizontal, vertikal: el.vertikal}}))
      })
    }
  ...
  return (
  <>
    <img src={require("../img/longsor_logo.png")} alt="" style={{position:"absolute", width:"15%", marginLeft:"70%", marginTop:"13%", zIndex:"-1"}}/>
    <Typography variant="subtitle2" style={{marginLeft:"13%", color:"#2DA4B9", marginBottom:"5px"}}>&ensp;<b>Longsor</b></Typography>
      ...
      <Table className={classes.table}>
        <TableHead style={{backgroundColor:"#f5f5f5"}}>
          <TableRow>
            ...
            <TableCell align="left"><Typography color="textSecondary"><b>Horizontal</b></Typography></TableCell>
            <TableCell align="left"><Typography color="textSecondary"><b>Vertikal</b></Typography></TableCell>
          </TableRow>
        </TableHead>
      <TableBody>
    {
        ...
        return(
          <>
            <TableRow>
              ...
              <TableCell align="left"><Typography color="textSecondary">{item.horizontal} cm</Typography></TableCell>
              <TableCell align="left"><Typography color="textSecondary">{item.vertikal} cm</Typography></TableCell>
            </TableRow>
          </>
        )
      })
