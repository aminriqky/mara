...
<body>
    <div class="card">
        <h3 class="">Halo {{$name}} ! ada {{$ground2}} daerah yang tanahnya longsor !</h3>
        <hr class="garis">
        <p>Telah terjadi tanah longsor di beberapa kawasan di Sumatera selatan. Berikut ini list daerah tersebut.</p>
        <table class="table1">
            <tr>
                <th>No</th>
                <th>Nama Lokasi</th>
